                ...
                <table>
                   ...
                   <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="isexchange" value="2"/>是否允许积分兑换
                        </td>
                    </tr>
                    <tr>
                        <td>积分兑换数:</td>
                        <td><input class="easyui-textbox" name="point" style="width:200px"/></td>
                    </tr>
                </table>
            </div>
            <div title="介绍" style="padding:20px;">

                <td ><textarea id="editor_id" rows="" cols="" name="introduction"></textarea></td>
