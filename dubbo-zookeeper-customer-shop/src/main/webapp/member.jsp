    ...
    $(function(){
        $('#m-tabs').bootstrapTable({
            ...
            columns:[
                ...
                {field:'isenabled',title:'状态',width:225},
                {field:'ss',title:'操作',width:225,formatter:function(value,row,index){
                    return '<a href="javascript:updateMemberRank("\'"+row.memberid+"\'")">[编辑]</a>';
                    return '<a href="javascript:updateMemberRank("\'"+row.memberid+"\'")">[查看]</a>';
                }},
            ]
        })
    })
