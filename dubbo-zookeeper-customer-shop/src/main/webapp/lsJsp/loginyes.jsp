        ...
        <div class="o_g l-nav">
            ...
            <ul class="o_u o_df_7-12 o_df-center o_md-hide o_sm-hide o_xs-hide js_navSearchLgHide">
                ...
                <li class="nav-column js_column" column='3'>
                    <a href="<%=request.getContextPath()%>/lsJsp/fuwua.jsp">
            ...
            <div class="o_u o_df_2-12 o_lg-hide o_md-hide o_sm-hide o_xs-hide">
               ...
               <%-- <div class="nav-user" id="logoutDiv">
                ...
                <div class="nav-user" id="loginDiv">
                    ...
                    <a class="nav-chart" href="<%=request.getContextPath()%>/lsJsp/washing.jsp"><i class="iconfont icon-shoppingcart"></i>&nbsp;&nbsp;我的购物车</a>
                </div>
            </div>
            <!-- 用户信息栏 sf/xl分辨率 END -->
            <!-- 用户信息栏 lg分辨率 -->
            ...
            <div class="o_u o_df_2-2 nav-md js_navMdShow">
                ...
                <ul class="o_u o_df_10-12 nav-mdbox">
                    ...
                    <li><a href="<%=request.getContextPath()%>/lsJsp/youshenghuo.jsp">悠生活<i class="iconfont icon-arrow-line-right"></i></a></li>
                    <li><a href="<%=request.getContextPath()%>/lsJsp/huiyuan.jsp">会员<i class="iconfont icon-arrow-line-right"></i></a></li>
                    <li><a href="<%=request.getContextPath()%>/lsJsp/fuwua.jsp">服务<i class="iconfont icon-arrow-line-right"></i></a></li>
                </ul>
            </div>
            <!-- 导航 md End -->
