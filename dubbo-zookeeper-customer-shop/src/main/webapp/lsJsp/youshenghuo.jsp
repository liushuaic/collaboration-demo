...
<head>
    ...
    <link rel="stylesheet" href="http://www.tongshuai.com/images/mediaelementplayer.css">
    <link rel="stylesheet" type="text/css" href="http://image.tongshuai.com/tongshuai/images/life_style.css">
    ...
    <div class="o_main">
        ...
        <div class="o_g aboutus_banner">
            ...
            <div class="o_u o_df_3-12 o_md_4-12 o_sm_5-12 o_xs_2-2 aboutus_head">
                <p class="aboutus_head_title">关于迷糊</p>
                <p class="aboutus_head_text">迷糊电器是海尔集团在互联网背景下，继海尔、卡萨帝之后战略布局的年轻化品牌。定位于“轻时尚家电开创者”，并提出“轻时尚 悠生活”的品牌主张，致力于为用户打造一种时尚、简约、悠闲、舒适的生活方式。</p>
                <p class="aboutus_head_text">迷糊旗下产品涵盖冰箱、洗衣机、空调、热水器、厨电、冷柜、彩电等七大品类，均由全球顶尖工程师联合设计打造，现已拥有上千万忠实用户，获得行业内30余项大奖。</p>
                <div class="btn_wrap_life">
                    <div class="btn_pup">
                        <a href="http://www.tongshuai.com/about/brand/">
                            了解更多
                        </a>
                    </div>
                    <div class="btn_pup">
                        <a href="http://www.tongshuai.com/about/news/">
                            新闻动态
                        </a>
                    </div>
                </div>
            ...
            <div class="o_u o_df_7-12 o_md_6-12 o_sm_5-12 o_xs_2-2 aboutus_head_banner">
                <img class="js_recPic_pic" src="" df="/images/aboutus_banner_df.png" lg="/images/aboutus_banner_lg.png" md="/images/aboutus_banner_md.png" sm="/images/aboutus_banner_md.png" xs="/images/aboutus_banner_xs.png" />
            </div>
        </div>
        <!-- 品牌简介banner END -->
        <div class="o_g life_wrap">
            ...
            <div class="life-style-player js_playerBox">
                <video id="player" class="o_df-hide js_jchg_video player" src="http://video.tongshuai.com/masvod/public/2017/12/24/20171224_160889162e4_r1_800k.mp4"
            ...
            <div class="life-style-video-box js_styleVideoBox">
                <div class="life-style-video-cont js_styleVideoCont">
                    <a href="javascript:;" class="o_u o_df_3-12 o_lg_2-12 video-cont-left js_styleVideoContLeft"
                       data-alt="false">
                        <img class="js_recPic" src="http://image.tongshuai.com/tongshuai/images/img48-23.png" df="http://image.tongshuai.com/tongshuai/life/leisurelylife_banner/W020171223495607432867.png" alt="" />
                    </a>
                        ...
                        <div class="js_lifeStyleVideoSwipe o_u o_df_11-12" style="overflow: hidden;">
                            <ul class="o_u o_df_12-12 swiper-wrapper">
                                <li class="o_u o_df_12-12  video-cont-md-imgmax js_videoMdImgMaxL swiper-slide"
                                    ...
                                    <img class="js_recPic" src="http://image.tongshuai.com/tongshuai/images/img48-23.png" df="http://image.tongshuai.com/tongshuai/life/leisurelylife_banner/W020171223495607432867.png" width="100%" alt="" />
                                </li>
                                <li class=" o_u o_df_12-12  video-cont-md-imgmax js_videoMdImgMaxR swiper-slide"
                                    data-index="2" data-gif="">
                                    <img class="js_recPic" src="http://image.tongshuai.com/tongshuai/images/img48-23.png" df="http://image.tongshuai.com/tongshuai/life/leisurelylife_banner/W020171223495607083252.png" width="100%" alt="" />
                                </li>
                            </ul>
                        </div>
                        <div class=" video-cont-md-imgmin  o_u o_df_1-12 js_videoMdImgMin">
                            <img class="" src="http://image.tongshuai.com/tongshuai/images/img48-23.png" df="http://image.tongshuai.com/tongshuai/life/leisurelylife_banner/W020171223495607432867.png" alt="" />
                        </div>
                    </div>
                    <div class="o_u o_df_6-12 o_lg_8-12  o_md_12-12 o_sm_12-12 o_xs_12-12 video-cont-center">
                        <img src="http://image.tongshuai.com/tongshuai/images/style_life_title.png" alt="" />
                        <p>
                        ...
                        <a href="javascript:;" class="js_lifeStylePlay"
                           data-src="http://video.tongshuai.com/masvod/public/2017/12/24/20171224_160889162e4_r1_800k.mp4"><img src="http://image.tongshuai.com/tongshuai/images/style_life_play.png" alt="" />
                        </a>
                    </div>
                    <a href="javascript:;" class="o_u o_df_3-12 o_lg_2-12 video-cont-right js_styleVideoContRight"
                       data-alt="false">
                        <img class="js_recPic" src="http://image.tongshuai.com/tongshuai/images/img48-23.png" df="http://image.tongshuai.com/tongshuai/life/leisurelylife_banner/W020171223495607083252.png" alt="" />
                    </a>
                </div>
            ...
            <div class="life-style-photo-box js_lifeStylePhotoBox">
                <div class="o_u o_df_2-12 o_lg_1-12 o_md_1-12 o_sm_1-12 o_xs_1-12 js_lifeStylePhotoLeft  life-style-photo-list-left">
                    <div class="photo-list-img  js_lifeStylePhotoCentent">
                        <img src="" alt="" />
                    </div>
                    <div class="life-style-photo-cur-text">
                        <img src="http://image.tongshuai.com/tongshuai/images/style_photo_1_text.png" alt="" />
                    </div>
                </div>
                <a href="javascript:;" class="o_u iconfont icon-arrow-jiantou-left js_photoLeftBtn o_df_1-12"></a>
                <div class="o_u o_df_6-12  o_lg_8-12 o_lg_8-12 o_md_8-12 o_sm_8-12 o_xs_10-12  life-style-photo-list-center ">
                    <div class="swiper-container js_lifeStyleGoodLifeSwipe">
                        <div class="swiper-wrapper" >

                            <div class="swiper-slide" data-index="1">
                                <div class="photo-list-img js_lifeStylePhotoCentent">
                                    <img class="js_recPic" src="http://image.tongshuai.com/tongshuai/images/img1-1.png" df="http://image.tongshuai.com/tongshuai/life/leisurelylife_lb/W020171225696063204277.jpg" alt="" />
                                </div>
                            ...
                            <div class="swiper-slide" data-index="2">
                                <div class="photo-list-img js_lifeStylePhotoCentent">
                                    <img class="js_recPic" src="http://image.tongshuai.com/tongshuai/images/img1-1.png" df="http://image.tongshuai.com/tongshuai/life/leisurelylife_lb/W020171225695864764815.jpg" alt="" />
                                </div>
                            ...
                            <div class="swiper-slide" data-index="3">
                                <div class="photo-list-img js_lifeStylePhotoCentent">
                                    <img class="js_recPic" src="http://image.tongshuai.com/tongshuai/images/img1-1.png" df="http://image.tongshuai.com/tongshuai/life/leisurelylife_lb/W020171225695648819997.jpg" alt="" />
                                </div>
                ...
                <a href="javascript:;" class="o_u o_df_1-12 iconfont icon-arrow-jiantou-right js_photoRightBtn"></a>
                <div class="o_u o_df_2-12 o_lg_1-12 o_md_1-12 o_sm_1-12 o_xs_1-12  life-style-photo-list-right js_lifeStylePhotoRight">
                    <div class="photo-list-img-2 js_lifeStylePhotoCentent">
                        <img src="" alt="" />
                    </div>
                </div>
                ...
                <div class="o_u o_df_8-12 o_lg_10-12 o_md_10-12 o_sm_10-12 o_xs_10-12">
                    ...
                    <div class="life-style-photo-cur-text js_lifeStyelGoodLifeDown beauty_text">
                        ...
                        <p class="js_lifeStyelGoodLifeText">
                            我们将对生活的理解转化成产品语言，并注入每一件迷糊产品的基因中<br/>希望家电这一长久陪伴于你的生活物品，可以与你完美契合，给你悠然惬意的生活
                        </p>
                    </div>
            ...
            <div class="life-style-superiority js_superiorityBox " data-type="1">
                ...
                <ul class="o_u o_df_4-12 o_md_12-12 o_sm_12-12 o_xs_12-12 js_superiorityCenter " stat="1">
                    <li class="o_u o_df_12-12  ">
                        <p>享用海尔全球设计研发资源<br/>确保迷糊独特的品牌个性</p>
                    </li>
                ...
                <ul class="o_u o_df_4-12 o_md_12-12 o_sm_12-12 o_xs_12-12 js_superiorityCenter" style="display: none;">
                    <li class="o_u o_df_12-12  ">
                        <p>完全承接海尔售后服务体系<br/>保障迷糊全方位服务体系</p>
                    </li>
                    <li class="o_u o_df_12-12 o_md_4-12 o_sm_4-12 o_xs_4-12">
                ...
                <div class="superiority-xs-modile">
                    <div class="superiority-left-text-xs o_u o_xs_12-12">
                        <div class="o_u o_df_4-12 xs-img-box">
                            <img src="http://image.tongshuai.com/tongshuai/images/style_life_superiority_1min.jpg" height="100%" alt="" />
                        </div>
                        <div class="o_u o_df_1-12"></div>
                    ...
                    <div class="superiority-right-text-xs o_u o_xs_12-12">
                        <div class="o_u o_df_4-12 xs-img-box">
                            <img src="http://image.tongshuai.com/tongshuai/images/style_life_superiority_2min.jpg" height="100%" alt="" />
                        </div>
                        <div class="o_u o_df_1-12"></div>
                        <div class="superiority-left-down o_u o_df_10-12 o_xs_6-12">
                            <h3>完美的体验是恰到好处</h3>
                    ...
                    <div class="superiority-left-text-xs o_u o_xs_12-12">
                        <div class="o_u o_df_4-12 xs-img-box">
                            <img src="http://image.tongshuai.com/tongshuai/images/style_life_superiority_3min.jpg" height="100%" alt="" />
                        </div>
                        <div class="o_u o_df_1-12"></div>
                        <div class="superiority-left-down o_u o_df_10-12 o_xs_6-12">
                            <h3>品质是亘古不变的追求</h3>
                    ...
                    <div class="superiority-right-text-xs o_u o_xs_12-12">
                        <div class="o_u o_df_4-12 xs-img-box">
                            <img src="http://image.tongshuai.com/tongshuai/images/style_life_superiority_4min.jpg" height="100%" alt="" />
                        </div>
                        <div class="o_u o_df_1-12"></div>
                        <div class="superiority-left-down o_u o_df_10-12 o_xs_6-12">
                            <h3>服务是贴心的无形陪伴</h3>
                    ...
                    <div class="o_u o_df_4-12 o_md_5-12 o_sm_5-12 o_xs_12-12 superiority-left-box js_superioritySwiperLeft">
                        <div class="swiper-wrapper">
                            <div class="superiority-left js_lifeStyleSuperiorityL swiper-slide o_u o_df_12-12 o_xs_12-12">
                                <img src="http://image.tongshuai.com/tongshuai/images/style_life_superiority_3min.jpg" alt="" />
                                <a href="javascript:;"
                                   class="superiority-img-btn 1111 iconfont icon-arrow-jiantou-left js_superiorityLeftBtn "></a>
                                <div class="superiority-left-cont ">
                                    <img src="http://image.tongshuai.com/tongshuai/images/superiority-left-cont3.png" alt="" />
                                    <h3>是亘古不变的追求</h3>
                                    <p>完善流程制造体系，实现全流程的质量预防，同时建立管控体系、改善等体系，锻造产品卓越品质，只为给用户可陪伴一生的产品</p>
                                </div>
                            </div>
                            <div class="superiority-left superiority-left2 js_lifeStyleSuperiorityL swiper-slide o_u o_df_12-12 o_xs_12-12">
                                <img src="http://image.tongshuai.com/tongshuai/images/style_life_superiority_1min.jpg" alt="" />
                                <a href="javascript:;"
                                   class=" js_superiorityLeftBtn superiority-img-btn iconfont icon-arrow-jiantou-left"></a>
                                <div class="superiority-left-cont ">
                                    <img src="http://image.tongshuai.com/tongshuai/images/superiority-left-cont1.png" alt="" />
                                    <h3>是不会褪色的时尚</h3>
                                    <p>来自国际顶级设计大咖倾心打造的产品，重新诠释时尚简约，干净简洁的设计摒除一切多余繁杂，与环境自然相融，用至简元素勾勒出时尚家居格调</p>
                                </div>
                            </div>
                    ...
                    <div class="o_u o_df_4-12  o_md_5-12  o_sm_5-12 o_xs_12-12 superiority-left-box js_superioritySwiperRight">
                        <div class="swiper-wrapper">
                            ...
                            <div class="superiority-right js_lifeStyleSuperiorityL swiper-slide o_u o_df_12-12 o_xs_4-12">
                                <img src="http://image.tongshuai.com/tongshuai/images/style_life_superiority_4min.jpg" alt="" />
                                <a href="javascript:;"
                                   class="superiority-img-btn iconfont icon-arrow-jiantou-right js_superiorityRightBtn"></a>
                                <div class="superiority-left-cont ">
                                    <img src="http://image.tongshuai.com/tongshuai/images/superiority-left-cont4.png" alt="" />
                                    <h3>是贴心的无形陪伴</h3>
                                    <p>全国热线提供订单执行、渠道网络、促销活动等专业服务。完全承接海尔集团售后服务网点，实现24小时响应、按约送达、送装同步等服务</p>
                                </div>
                            </div>
                            <div class="superiority-right superiority-right2 js_lifeStyleSuperiorityL swiper-slide o_u o_df_12-12 o_xs_4-12">
                                <img src="http://image.tongshuai.com/tongshuai/images/style_life_superiority_2min.jpg" alt="" />
                                <a href="javascript:;"
                                   class="superiority-img-btn iconfont icon-arrow-jiantou-right js_superiorityRightBtn"></a>
                                <div class="superiority-left-cont ">
                                    <img src="http://image.tongshuai.com/tongshuai/images/superiority-left-cont2.png" alt="" />
                                    <h3>的体验是恰到好处</h3>
                                    <p>返璞归真，追求家电基础功能的精益求精，用心锻造高品质、不花哨的全系产品，为用户提供恰到好处的功能满足，让用户从生活琐事中解放</p>
                                </div>
                            </div>
            ...
            <div class="life-style-case">
                    ...
                    <div class="js_lifeStyleCasePhoto life-case-photo-swiper" style="overflow: hidden;">
                        <div class="swiper-wrapper" id="lifepic">
                            ...
                            <div class="swiper-slide" data-index="">
                                <img src="http://image.tongshuai.com/tongshuai/life/leisurelylife_life/W020171225657029361871.jpg" width="100%" alt="" />
                            </div>

                            <div class="swiper-slide" data-index="">
                                <img src="http://image.tongshuai.com/tongshuai/life/leisurelylife_life/W020171225658044471801.jpg" width="100%" alt="" />
                            </div>

                            <div class="swiper-slide" data-index="">
                                <img src="http://image.tongshuai.com/tongshuai/life/leisurelylife_life/W020171225658445178067.jpg" width="100%" alt="" />
                            </div>
                ...
                <ul class="o_u o_df_4-12 o_md_8-12  o_sm_8-12  o_xs_8-12 life-case-text-box js_lifeStyleCaseText">
                    ...
                    <li class="cur">
                        <img src="http://image.tongshuai.com/tongshuai/images/life_title.png" alt="" class="life_title_pic" />
                        <div class="life-case-text"><img src="http://image.tongshuai.com/tongshuai/images/life-style-case-titleleft.png" class="left" alt="" />
                            结缘迷糊是同事与目前的推荐，而我的理工男丈夫又对家电的科技情有独钟。人与家电通过网络的联系越来越紧密，选择家电，还是要有点科技含量。
                            <img src="http://image.tongshuai.com/tongshuai/images/life-style-case-titleright.png" class="right" alt="" /></div>
                    ...
                    <li class="cur">
                        <img src="http://image.tongshuai.com/tongshuai/images/life_title.png" alt="" class="life_title_pic" />
                        <div class="life-case-text"><img src="http://image.tongshuai.com/tongshuai/images/life-style-case-titleleft.png" class="left" alt="" />
                            终于有了自己的家，选家电时觉得迷糊简约的风格特别符合，一口气买了不少。明年夏天热的话，再装空调也要迷糊的，这样一家子就齐全了。
                            <img src="http://image.tongshuai.com/tongshuai/images/life-style-case-titleright.png" class="right" alt="" /></div>
                        <div class="life-case-text-down">
                            <p>
                                延边小城的幸福新人
            ...
            <div class="life-style-create">
                    ...
                    <div class="o_u life-style-create-cont js_lifeStyleCont o_sm_10-12 o_xs_10-12">
                        <div>
                            <div class="create-title-img ">
                                <img src="http://image.tongshuai.com/tongshuai/images/life-style-create-cont-title.png" width="100%" alt="" />
                            </div>
                                ...
                                <div class="js_lifeStyleCreateSwipe lbindex">
                                    <ul class="swiper-wrapper">
                                        ...
                                        <li class="o_u o_df_6-12 swiper-slide">
                                            <div class="o_u o_df_2-2">
                                                <div class="o_u o_df_4-12 o_sm_11-12 o_xs_11-12  list-cont-photo">
                                                    <a href="http://www.tongshuai.com/televisions/20171213_621.shtml">
                                                        <img src='http://image.tongshuai.com/tongshuai/televisions/W020171213638435766412.png' alt="" />
                                                    </a>
                                                </div>
                                        ...
                                        <li class="o_u o_df_6-12 swiper-slide">
                                            <div class="o_u o_df_2-2">
                                                <div class="o_u o_df_4-12 o_sm_11-12 o_xs_11-12  list-cont-photo">
                                                    <a href="http://www.tongshuai.com/televisions/20171213_619.shtml">
                                                        <img src='http://image.tongshuai.com/tongshuai/televisions/W020171213520502137136.png' alt="" />
                                                    </a>
                                                </div>
                                                <div class="o_u o_df_8-12 o_sm_11-12 o_xs_11-12 list-cont-text">
                                                    <a href="http://www.tongshuai.com/televisions/20171213_619.shtml">
                                        ...
                                        <li class="o_u o_df_6-12 swiper-slide">
                                            <div class="o_u o_df_2-2">
                                                <div class="o_u o_df_4-12 o_sm_11-12 o_xs_11-12  list-cont-photo">
                                                    <a href="http://www.tongshuai.com/laundry/20171215_637.shtml">
                                                        <img src='http://image.tongshuai.com/tongshuai/laundry/W020171215702728858831.jpg' alt="" />
                                                    </a>
                                                </div>
                                                <div class="o_u o_df_8-12 o_sm_11-12 o_xs_11-12 list-cont-text">
                                                    <a href="http://www.tongshuai.com/laundry/20171215_637.shtml">
                                        ...
                                        <li class="o_u o_df_6-12 swiper-slide">
                                            <div class="o_u o_df_2-2">
                                                <div class="o_u o_df_4-12 o_sm_11-12 o_xs_11-12  list-cont-photo">
                                                    <a href="http://www.tongshuai.com/laundry/20171215_634.shtml">
                                                        <img src='http://image.tongshuai.com/tongshuai/laundry/W020171215481840749627.jpg' alt="" />
                                                    </a>
                                                </div>
                                                <div class="o_u o_df_8-12 o_sm_11-12 o_xs_11-12 list-cont-text">
                                                    <a href="http://www.tongshuai.com/laundry/20171215_634.shtml">
                                        ...
                                        <li class="o_u o_df_6-12 swiper-slide">
                                            <div class="o_u o_df_2-2">
                                                <div class="o_u o_df_4-12 o_sm_11-12 o_xs_11-12  list-cont-photo">
                                                    <a href="http://www.tongshuai.com/air_conditioners/20171214_633.shtml">
                                                        <img src='http://image.tongshuai.com/tongshuai/air_conditioners/W020171216393354350207.jpg' alt="" />
                                                    </a>
                                                </div>
                                                <div class="o_u o_df_8-12 o_sm_11-12 o_xs_11-12 list-cont-text">
                                                    <a href="http://www.tongshuai.com/air_conditioners/20171214_633.shtml">
                                        ...
                                        <li class="o_u o_df_6-12 swiper-slide">
                                            <div class="o_u o_df_2-2">
                                                <div class="o_u o_df_4-12 o_sm_11-12 o_xs_11-12  list-cont-photo">
                                                    <a href="http://www.tongshuai.com/air_conditioners/20171215_636.shtml">
                                                        <img src='http://image.tongshuai.com/tongshuai/air_conditioners/W020171216389357489393.jpg' alt="" />
                                                    </a>
                                                </div>
                                                <div class="o_u o_df_8-12 o_sm_11-12 o_xs_11-12 list-cont-text">
                                                    <a href="http://www.tongshuai.com/air_conditioners/20171215_636.shtml">
                ...
                <div class="o_u o_df_5-12 o_sm_12-12 o_xs_12-12 create-bottom-img">
                    <img src="http://image.tongshuai.com/tongshuai/images/create-bottom-img.jpg" width="100%" alt="" />
                </div>
...
<script type="text/javascript" src="http://www.tongshuai.com/images/mediaelement-and-player.js"></script>
<script type="text/javascript">
...
<script type="text/javascript" src="http://image.tongshuai.com/tongshuai/images/life_style.js"></script>
