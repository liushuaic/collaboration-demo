...
<script>
    ...
    function queryshipping(){
        $('#refundsTable').datagrid({
            url:'<%=request.getContextPath()%>/lsController/queryShippingList.jhtml',
            remoteSort:false,
            singleSelect:true,
            checkOnSelect:false,
            selectOnCheck:false,
            ...
            columns:[[
                ...
                {field:'shipsn',title:'编号',width:200,sortable:true},
                {field:'shippingmethod',title:'配送方式',width:200,align:'center',sortable:true},
                {field:'dcname',title:'物流公司',width:200,align:'center',sortable:true},
                {field:'trackingno',title:'运单号',width:200,align:'center',sortable:true},
                {field:'consignee',title:'收货人',width:200,align:'center',sortable:true},
