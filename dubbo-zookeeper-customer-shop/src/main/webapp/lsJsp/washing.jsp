...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://image.tongshuai.com/tongshuai/images/product_trolley.css">
...
<div class="o_body">
    <div class="o_main">
        ...
        <div class="o_g trolley-head">
            ...
            <div class="o_u o_df_10-12">
                <%--<div class="trolley-logo">--%>
                    <a href="javascript:aaa()"><img src="<%=request.getContextPath()%>/images/mih.png" width="150px" height="140px"/></a>
                <%--</div>--%>
                ...
                <span class="trolley-username js_userName">
                    <b> 当前用户:</b>
                    <!-- 胖大海 --><font color="aqua">${loginAdmin.username}</font>
                    </span>
            </div>
        </div>
        <!-- 头部 END -->
        ...
        <div class="o_g trolley-distribution">
            ...
            <div class="o_u o_df_10-12">
                ...
                <div class="distribution-address">
                    配送至：
                    <span class="js_ipAddress">山东省 青岛市 市南区</span>
                    <i class="iconfont icon-arrow-sanjiao-down-s"></i>
                </div>
            </div>
        </div>
        <!-- 配送 END -->
        ...
        <div class="o_g empty-trolley-pro-list">
            <img src="http://image.tongshuai.com/tongshuai/images/share_nothing.png" alt="" />
            <p>还没有任何商品，<a href="<%=request.getContextPath()%>/lsJsp/loginyes.jsp">快去挑选吧</a></p>
            <div>
            </div>
        </div>
...
<!--全局cookie end-->
<script type="text/javascript" src="http://image.tongshuai.com/tongshuai/images/jquery-jtemplates.js"></script>
<script type="text/javascript" src="http://image.tongshuai.com/tongshuai/images/product_trolley.js"></script>
            ...
            <div class="trolley-prolist" cartId="{$T.item.skuShowVO.cartGoodId}" inSkuCode="{$T.item.skuShowVO.inSkuCode}">
                <div class="o_g trolley-product">
                    <div class="o_u o_df_3-5 o_md_1-2 o_xs_2-2">
                        ...
                        <a class="trolley-product-img" href="{$T.item.productShowVO.proUrl || 'javascript:;'}" target="_blank" rel="noopener">
                            <img src="{$T.item.productShowVO.goodsPic}" />
                        </a>
                        <div class="trolley-product-font">
                            <div class="trolley-middle-box">
                                <div class="trolley-middle-inner js_trolleyFont">
