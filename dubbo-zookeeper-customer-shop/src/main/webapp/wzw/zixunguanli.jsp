...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'east',title:'角色管理列表'" collapsible="false" style="width: 100%">
        ...
        <table id="back-tabs" class="text-nowrap"></table>
    </div>
</div>
<div id="dd"></div>
<script type="text/javascript">
    $(function(){
        $('#back-tabs').bootstrapTable({
            toolbar:'#where',
            url:'<%=request.getContextPath()%>/zixun/queryZixunList.jhtml',
            pagination: true,
            pageList:[5, 10, 20, 50],
            pageSize:5,
            ...
            columns:[
                ...
                {field:'isback',title:'是否回复',width:225,formatter:function(value,row,index){
                    if (value == 1){
                        return "<font color='red'>×</font>";
                    }else{
                        return "<font color='green'>√</font>";
                ...
                {field:'ss',title:'操作',width:225,formatter:function(value,row,index){
                    return "<a href='javascript:back(\""+row.consuid+"\")'>[回复]</a>" +
                        " <a href='javascript:update(\""+row.consuid+"\")'>[编辑]</a>" +
                        "  <a href='javascript:query(\""+row.consuid+"\")'>[查看]</a>";
                }},
            ]
        })
    })
    ...
    function remove(id) {
        ...
        if (id != null && id != "") {
            ...
            var arr = $("#back-tabs").bootstrapTable('getSelections');
