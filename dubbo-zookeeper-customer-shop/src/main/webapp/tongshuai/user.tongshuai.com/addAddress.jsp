...
<form id="addressForm" method="post" onsubmit="return tijiao()">
    ...
    <table >
        <tr>
            <td>收货人:<font color="#a52a2a">*</font>:</td>
...
<script>
    ...
    function t2() {
        ...
        var arr = [
         /*   //省
            ["山西省","山西省",0],[2,"河北省",0],[3,"山东省",0],
            //市
            ["太原市","太原市","山西省"],[22,"石家庄市",2],[33,"菏泽市",3],
            [222,"邯郸市",2], [333,"烟台市",3],
            //区
            ...
            //省
            ["山西省","山西省",0],["河北省","河北省",0],["山东省","山东省",0],
            //市
            ["太原市","太原市","山西省"],["石家庄市","石家庄市","河北省"],["菏泽市","菏泽市","山东省"],
            ["邯郸市","邯郸市","河北省"], ["烟台市","烟台市","山东省"],
            //区
            ["小店区",,"小店区","太原市"],["杏花岭区","杏花岭区","太原市"],["牡丹区","牡丹区","菏泽市"],
            ["长安区","长安区","石家庄市"],["桥东区","桥东区","石家庄市"],["福山区","福山区","烟台市"],
