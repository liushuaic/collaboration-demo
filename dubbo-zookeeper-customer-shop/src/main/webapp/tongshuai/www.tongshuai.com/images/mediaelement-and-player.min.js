...
//if($ie8){
    $('audio,video').mediaelementplayer({
        ...
        showPosterWhenEnded:true,//æ˜¾ç¤ºæµ·æŠ¥
        autosizeProgress:false,//æ ¹æ®å…¶ä»–å…ƒç´ çš„å¤§å°è‡ªåŠ¨è®¡ç®—è¿›åº¦æ¡çš„å®½åº¦
        iPadUseNativeControls:true,//å¼ºåˆ¶iPadçš„åŽŸç”ŸæŽ§ä»¶
        iPhoneUseNativeControls:true,//å¼ºåˆ¶iPhoneçš„æœ¬æœºæŽ§ä»¶
        AndroidUseNativeControls:true,//å¼ºåˆ¶Androidçš„åŽŸç”ŸæŽ§ä»¶
        usePluginFullScreen: false,//åœ¨å…¨å±æ¨¡å¼ä¸‹æ¿€æ´»æŒ‡é’ˆäº‹ä»¶æ£€æµ‹çš„æ ‡å¿—
    });
//}