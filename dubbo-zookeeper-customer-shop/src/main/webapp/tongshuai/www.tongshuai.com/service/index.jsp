...
<head>
    ...
    <title>统帅售后服务与支持_自助服务 - 统帅官网</title>
    ...
    <link rel="stylesheet" type="text/css" href="../../image.tongshuai.com/tongshuai/images/serve_index.css" tppabs="http://image.tongshuai.com/tongshuai/images/serve_index.css">
</head>
    ...
    <div class="o_main">
        ...
        <div class="o_g l-nav">
            ...
            <ul class="o_u o_df_7-12 o_df-center o_md-hide o_sm-hide o_xs-hide js_navSearchLgHide">
                ...
                <li class="nav-column js_column" column='3'>
                    <a href="index.jsp" tppabs="http://www.tongshuai.com/service/">
            ...
            <div class="o_u o_df_2-2 nav-md js_navMdShow">
                ...
                <ul class="o_u o_df_10-12 nav-mdbox">
                    ...
                    <li><a href="index.jsp" tppabs="http://www.tongshuai.com/service/">服务<i class="iconfont icon-arrow-line-right"></i></a></li>
                </ul>
            </div>
            <!-- 导航 md End -->
            ...
            <ul class="o_u o_df_2-2 nav-searchresult-lg js_navSearchLg js_searchBox js_searchBox_lg">
                ...
                <div class="o_u o_df_8-12 o_xs_10-12 js_searchBox_root">
                    <div class="searchresult-quick js_searchBoxQuick_lg">
                        <span>快速链接：</span>
                        <a href="installation_and_maintenance/index.htm" tppabs="http://www.tongshuai.com/service/installation_and_maintenance">在线报修</a>
                        <!--<a href="http://user.tongshuai.com/product_registe">产品注册</a>-->
                        <a href="help/index.jsp" tppabs="http://www.tongshuai.com/service/help">帮助中心</a>
        ...
        <div class="serve_index_banner">
            ...
            <div class="banner_mid">
                ...
                <div class="mid_content">
                    <p class="banner_head">欢迎使用统帅服务</p>
                    <div class="search_banner">
                        ...
                        <div class="search_shadow">
                            <img src="../../image.tongshuai.com/tongshuai/images/serve_shadow.png" tppabs="http://image.tongshuai.com/tongshuai/images/serve_shadow.png" />
                        </div>
        ...
        <div class="o_g serve_entrance_service">
            <div class="o_u o_df_2-12 o_lg_4-12 o_md_4-12 o_sm_4-12 o_xs_1-2 service_item">
                <a href="installation_and_maintenance/index.shtml-datatype=1.htm" tppabs="http://www.tongshuai.com/service/installation_and_maintenance/index.shtml?datatype=1" target="_blank">
                    <div class="service_pic">
                        <img src="../../image.tongshuai.com/tongshuai/images/serve_entrance_installation.png" tppabs="http://image.tongshuai.com/tongshuai/images/serve_entrance_installation.png" />
                    </div>
            ...
            <div class="o_u o_df_2-12 o_lg_4-12 o_md_4-12 o_sm_4-12 o_xs_1-2 service_item">
                <a href="installation_and_maintenance/index.shtml-datatype=2.htm" tppabs="http://www.tongshuai.com/service/installation_and_maintenance/index.shtml?datatype=2" target="_blank">
                    <div class="service_pic">
                        <img src="../../image.tongshuai.com/tongshuai/images/serve_entrance_online.png" tppabs="http://image.tongshuai.com/tongshuai/images/serve_entrance_online.png" />
                    </div>
            ...
            <div class="o_u o_df_2-12 o_lg_4-12 o_md_4-12 o_sm_4-12 o_xs_1-2 service_item">
                <a target="_blank" class="add_after">
                    <div class="service_pic">
                        <img src="../../image.tongshuai.com/tongshuai/images/serve_entrance_reg.png" tppabs="http://image.tongshuai.com/tongshuai/images/serve_entrance_reg.png" />
                    </div>
            ...
            <div class="o_u o_df_2-12 o_lg_4-12 o_md_4-12 o_sm_4-12 o_xs_1-2 service_item" id="js_service_status">
                <a href="javascript:;" class="js_status">
                    <div class="service_pic">
                        <img src="../../image.tongshuai.com/tongshuai/images/serve_entrance_status.png" tppabs="http://image.tongshuai.com/tongshuai/images/serve_entrance_status.png" />
                    </div>
            ...
            <div class="o_u o_df_2-12 o_lg_4-12 o_md_4-12 o_sm_4-12 o_xs_1-2 service_item">
                <a href="javascript:;"  class="js_policy">
                    <div class="service_pic">
                        <img src="../../image.tongshuai.com/tongshuai/images/serve_entrance_policy.png" tppabs="http://image.tongshuai.com/tongshuai/images/serve_entrance_policy.png" />
                    </div>
            ...
            <div class="o_u o_df_2-12 o_lg_4-12 o_md_4-12 o_sm_4-12 o_xs_1-2 service_item">
                <a href="javascript:;"  class="js_downLoad">
                    <div class="service_pic">
                        <img src="../../image.tongshuai.com/tongshuai/images/serve_entrance_download.png" tppabs="http://image.tongshuai.com/tongshuai/images/serve_entrance_download.png" />
                    </div>
            ...
            <div class="o_u o_df_10-12 serve_class_content">
                <div class="o_g">
                    ...
                    <div class="o_u o_lg_1-4 o_md_1-3 o_sm_1-3 o_xs_1-2 class_item">
                        <a href="product_support/televisions/troubles/index.htm" tppabs="http://www.tongshuai.com/service/product_support/televisions/troubles/" target="_blank">

                            <img src="../../image.tongshuai.com/tongshuai/service/product_support/televisions/W020180322540371309866.png" tppabs="http://image.tongshuai.com/tongshuai/service/product_support/televisions/W020180322540371309866.png" />
                    ...
                    <div class="o_u o_lg_1-4 o_md_1-3 o_sm_1-3 o_xs_1-2 class_item">
                        <a href="product_support/laundry/troubles/index.htm" tppabs="http://www.tongshuai.com/service/product_support/laundry/troubles/" target="_blank">

                            <img src="../../image.tongshuai.com/tongshuai/service/product_support/laundry/W020180322540783318150.png" tppabs="http://image.tongshuai.com/tongshuai/service/product_support/laundry/W020180322540783318150.png" />
                    ...
                    <div class="o_u o_lg_1-4 o_md_1-3 o_sm_1-3 o_xs_1-2 class_item">
                        <a href="product_support/air_conditioners/troubles/index.htm" tppabs="http://www.tongshuai.com/service/product_support/air_conditioners/troubles/" target="_blank">

                            <img src="../../image.tongshuai.com/tongshuai/service/product_support/air_conditioners/W020180322541144401578.png" tppabs="http://image.tongshuai.com/tongshuai/service/product_support/air_conditioners/W020180322541144401578.png" />
                    ...
                    <div class="o_u o_lg_1-4 o_md_1-3 o_sm_1-3 o_xs_1-2 class_item">
                        <a href="product_support/cooling/troubles/index.htm" tppabs="http://www.tongshuai.com/service/product_support/cooling/troubles/" target="_blank">

                            <img src="../../image.tongshuai.com/tongshuai/service/product_support/cooling/W020180322541538620773.png" tppabs="http://image.tongshuai.com/tongshuai/service/product_support/cooling/W020180322541538620773.png" />
                    ...
                    <div class="o_u o_lg_1-4 o_md_1-3 o_sm_1-3 o_xs_1-2 class_item">
                        <a href="product_support/freezer/troubles/index.htm" tppabs="http://www.tongshuai.com/service/product_support/freezer/troubles/" target="_blank">

                            <img src="../../image.tongshuai.com/tongshuai/service/product_support/freezer/W020180322542082438779.png" tppabs="http://image.tongshuai.com/tongshuai/service/product_support/freezer/W020180322542082438779.png" />
                    ...
                    <div class="o_u o_lg_1-4 o_md_1-3 o_sm_1-3 o_xs_1-2 class_item">
                        <a href="product_support/water_heater/troubles/index.htm" tppabs="http://www.tongshuai.com/service/product_support/water_heater/troubles/" target="_blank">

                            <img src="../../image.tongshuai.com/tongshuai/service/product_support/water_heater/W020180322542481982490.png" tppabs="http://image.tongshuai.com/tongshuai/service/product_support/water_heater/W020180322542481982490.png" />
                    ...
                    <div class="o_u o_lg_1-4 o_md_1-3 o_sm_1-3 o_xs_1-2 class_item">
                        <a href="product_support/cooking_appliances/troubles/index.htm" tppabs="http://www.tongshuai.com/service/product_support/cooking_appliances/troubles/" target="_blank">

                            <img src="../../image.tongshuai.com/tongshuai/service/product_support/cooking_appliances/W020180322542868612327.png" tppabs="http://image.tongshuai.com/tongshuai/service/product_support/cooking_appliances/W020180322542868612327.png" />
            ...
            <div class="o_u o_df_10-12 serve_contact_pic">
                <div class="contact_box">
                    <div class="contact_pic">
                        <img src="../../image.tongshuai.com/tongshuai/images/serve_contact_df.png" tppabs="http://image.tongshuai.com/tongshuai/images/serve_contact_df.png" />
                    </div>
                    <div class="serve_contact_text">
                        ...
                        <div class="contact_goods">
                            <span class="gift_title">了解统帅最新资讯，参与互动好礼：</span>
                            <a class="contact_weibo" href="javascript:if(confirm('https://weibo.com/u/2003689247  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ�����·���ⲿ������Ϊ������ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ���?'))window.location='https://weibo.com/u/2003689247'" tppabs="https://weibo.com/u/2003689247" target="_blank">
                                <i class="iconfont icon-share-weibo"></i>
                            </a>
                            <a class="contact_weixin">
                                <i class="iconfont icon-share-weixin"></i>
                                <div class="l-float-top">
                                    <img src="../../image.tongshuai.com/tongshuai/images/tongshuai_weixin.jpg" tppabs="http://image.tongshuai.com/tongshuai/images/tongshuai_weixin.jpg" />
                                    <p></p><i></i>
                                </div>
                            </a>
                        </div>
                ...
                <div class="content_pup">
                    <div class="o_g product_wrap">
                        ...
                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="product_support/televisions/warranty/index.htm" tppabs="http://www.tongshuai.com/service/product_support/televisions/warranty/" target="_blank">
                                <img src="product_support/televisions/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/televisions/material/icon.png" />
                                <p class="product_name">电视</p>
                            </a>
                        </div>

                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="product_support/laundry/warranty/index.htm" tppabs="http://www.tongshuai.com/service/product_support/laundry/warranty/" target="_blank">
                                <img src="product_support/laundry/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/laundry/material/icon.png" />
                                <p class="product_name">洗衣机</p>
                            </a>
                        </div>

                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="product_support/air_conditioners/warranty/index.htm" tppabs="http://www.tongshuai.com/service/product_support/air_conditioners/warranty/" target="_blank">
                                <img src="product_support/air_conditioners/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/air_conditioners/material/icon.png" />
                                <p class="product_name">空调</p>
                            </a>
                        </div>

                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="product_support/cooling/warranty/index.htm" tppabs="http://www.tongshuai.com/service/product_support/cooling/warranty/" target="_blank">
                                <img src="product_support/cooling/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/cooling/material/icon.png" />
                                <p class="product_name">冰箱</p>
                            </a>
                        </div>

                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="product_support/freezer/warranty/index.htm" tppabs="http://www.tongshuai.com/service/product_support/freezer/warranty/" target="_blank">
                                <img src="product_support/freezer/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/freezer/material/icon.png" />
                                <p class="product_name">冷柜</p>
                            </a>
                        </div>

                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="product_support/water_heater/warranty/index.htm" tppabs="http://www.tongshuai.com/service/product_support/water_heater/warranty/" target="_blank">
                                <img src="product_support/water_heater/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/water_heater/material/icon.png" />
                                <p class="product_name">热水器</p>
                            </a>
                        </div>

                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="product_support/cooking_appliances/warranty/index.htm" tppabs="http://www.tongshuai.com/service/product_support/cooking_appliances/warranty/" target="_blank">
                                <img src="product_support/cooking_appliances/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/cooking_appliances/material/icon.png" />
            ...
            <div class="service_pup service_pup_downLoad js_service_pup js_pup_downLoad">
                ...
                <div class="content_pup">
                    <div class="o_g product_wrap">
                        ...
                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="Instructions/index.shtml-type=电视.htm" tppabs="http://www.tongshuai.com/service/Instructions/index.shtml?type=电视" target="_blank">
                                <img src="product_support/televisions/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/televisions/material/icon.png" />
                                <p class="product_name">电视</p>
                            </a>
                        </div>
                        ...
                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="Instructions/index.shtml-type=洗衣机.htm" tppabs="http://www.tongshuai.com/service/Instructions/index.shtml?type=洗衣机" target="_blank">
                                <img src="product_support/laundry/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/laundry/material/icon.png" />
                                <p class="product_name">洗衣机</p>
                            </a>
                        </div>
                        ...
                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="Instructions/index.shtml-type=空调.htm" tppabs="http://www.tongshuai.com/service/Instructions/index.shtml?type=空调" target="_blank">
                                <img src="product_support/air_conditioners/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/air_conditioners/material/icon.png" />
                                <p class="product_name">空调</p>
                            </a>
                        </div>
                        ...
                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="Instructions/index.shtml-type=冰箱.htm" tppabs="http://www.tongshuai.com/service/Instructions/index.shtml?type=冰箱" target="_blank">
                                <img src="product_support/cooling/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/cooling/material/icon.png" />
                                <p class="product_name">冰箱</p>
                            </a>
                        </div>
                        ...
                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="Instructions/index.shtml-type=冷柜.htm" tppabs="http://www.tongshuai.com/service/Instructions/index.shtml?type=冷柜" target="_blank">
                                <img src="product_support/freezer/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/freezer/material/icon.png" />
                                <p class="product_name">冷柜</p>
                            </a>
                        </div>
                        ...
                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="Instructions/index.shtml-type=热水器.htm" tppabs="http://www.tongshuai.com/service/Instructions/index.shtml?type=热水器" target="_blank">
                                <img src="product_support/water_heater/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/water_heater/material/icon.png" />
                                <p class="product_name">热水器</p>
                            </a>
                        </div>
                        ...
                        <div class="o_u o_df_1-4 o_xs_1-3 product_item">
                            <a href="Instructions/index.shtml-type=厨电.htm" tppabs="http://www.tongshuai.com/service/Instructions/index.shtml?type=厨电" target="_blank">
                                <img src="product_support/cooking_appliances/material/icon.png" tppabs="http://www.tongshuai.com/service/product_support/cooking_appliances/material/icon.png" />
                                <p class="product_name">厨电</p>
                            </a>
                        </div>
            ...
            <div class="o_u o_df_10-12">
                <div class="o_g footer_box">
                    ...
                    <div class="o_u o_df_1-6 o_md_1-4 o_sm_2-2 o_xs_2-2">
                        ...
                        <div class="foot_linkbox js_footLink">
                            <a class="foot_link" href="installation_and_maintenance/index.shtml-datatype=1.htm" tppabs="http://www.tongshuai.com/service/installation_and_maintenance/index.shtml?datatype=1">预约安装</a>
                            <a class="foot_link" href="installation_and_maintenance/index.shtml-datatype=2.htm" tppabs="http://www.tongshuai.com/service/installation_and_maintenance/index.shtml?datatype=2">在线报修</a>
                            <span class="foot_link">产品注册</span>
                            <a class="foot_link" href="Instructions/index.htm" tppabs="http://www.tongshuai.com/service/Instructions/">使用手册下载</a>
                        </div>
                    </div>
                    <div class="o_u o_df_1-6 o_md_1-4 o_sm_2-2 o_xs_2-2">
                        <div class="foot_head js_footLindBtn">
...
<script type="text/javascript" src="../../image.tongshuai.com/tongshuai/images/serve_action.js" tppabs="http://image.tongshuai.com/tongshuai/images/serve_action.js"></script>
<script type="text/javascript" src="../../image.tongshuai.com/tongshuai/images/serve_index.js" tppabs="http://image.tongshuai.com/tongshuai/images/serve_index.js"></script>
<script type="text/javascript" src="../../image.tongshuai.com/tongshuai/images/templet_service_index.js" tppabs="http://image.tongshuai.com/tongshuai/images/templet_service_index.js"></script>
<script type="text/javascript" src="../../v3.jiathis.com/code/jia.js" tppabs="http://v3.jiathis.com/code/jia.js" charset="utf-8"></script>
<script type="text/javascript">
    var jiathis_config = {
        pic: "",
        summary: "",
    ...
    //banner
    var templet_left_pic="../../image.tongshuai.com/tongshuai/service/W020180322561409416594.png,http-/image.tongshuai.com/tongshuai/service/W020180322561829692480.png"/*tpa=http://image.tongshuai.com/tongshuai/service/W020180322561409416594.png,http://image.tongshuai.com/tongshuai/service/W020180322561829692480.png*/;
    var templet_right_pic="../../image.tongshuai.com/tongshuai/service/W020180322561409116549.png,http-/image.tongshuai.com/tongshuai/service/W020180322561829401626.png"/*tpa=http://image.tongshuai.com/tongshuai/service/W020180322561409116549.png,http://image.tongshuai.com/tongshuai/service/W020180322561829401626.png*/;
