...
<head>
    ...
    <title>【统帅热水器】电_燃气_热水器   介绍_价格 - 统帅官网</title>
    <meta name="keywords" content="【统帅热水器】电_燃气_热水器   介绍_价格 - 统帅官网" />
    <meta name="description" content="【统帅热水器】电_燃气_热水器   介绍_价格 - 统帅官网" />
    ...
    <div class="o_main">
                ...
                <ul class="o_u o_df_10-12 nav-mdbox">
                    ...
                    <li>
                        ...
                        <ul class="nav-mdbox-second js_navMdboxSecond">
                            ...
                            <li>
                                <a href="index.jsp" tppabs="http://www.tongshuai.com/water_heater/">
                                    <div class="nav-mdbox-icon">
        ...
        <div class="o_g list-nav">
            <div class="o_u o_df_2-2 list-nav-img">
                ...
                <img src="../../image.tongshuai.com/tongshuai/water_heater/W020171223690670285702.jpg" tppabs="http://image.tongshuai.com/tongshuai/water_heater/W020171223690670285702.jpg" class="o_u o_df_2-2 js_bannerImg" />


                <div class="list-nav-type black">

                    <div class="nav-type-img">
                        <img src="../../image.tongshuai.com/tongshuai/water_heater/W020171223690670660826.png" tppabs="http://image.tongshuai.com/tongshuai/water_heater/W020171223690670660826.png" />
                    </div>
                    <div class="nav-type-en">WATER HEATER</div>
                    <div class="nav-type-china">热水器</div>
                </div>
            ...
            <div class="o_u o_df_10-12">
                <div class="list-kind-box">
                    <div class="list-kind js_showFloatList">
                        <div class="list-kind-icon">
                            ...
                            <img src="images/P020170925572321617383.png" tppabs="http://www.tongshuai.com/water_heater/images/P020170925572321617383.png"/>


                        </div>
                        <div class="list-kind-font">

                            <span class="list-kind-china">热水器<i class="iconfont icon-arrow-line-down"></i><i class="iconfont icon-arrow-line-up"></i></span>


                            <span class="list-kind-english">WATER HEATER</span>
                    ...
                    <div class="list-type o_md-hide o_sm-hide o_xs-hide js_proNameBox">
                        ...
                        <a class="nav-link active" channelid="75" href="index.htm" tppabs="http://www.tongshuai.com/water_heater/">全部</a>

                        <a class="nav-link"  channelid="98" href="drsq/index.htm" tppabs="http://www.tongshuai.com/water_heater/drsq/">电热水器</a>

                        <a class="nav-link"  channelid="99" href="rqrsq/index.htm" tppabs="http://www.tongshuai.com/water_heater/rqrsq/">燃气热水器</a>

                        <a class="nav-link"  channelid="100" href="kqnrsq/index.htm" tppabs="http://www.tongshuai.com/water_heater/kqnrsq/">空气能热水器</a>
                ...
                <div class="list-categray o_df-hide o_md-show o_sm-show o_xs-show js_proNameBox2">
                    <a class="active" channelid="75" href="index.jsp" tppabs="http://www.tongshuai.com/water_heater/">全部</a>

                    <a href="drsq/index.htm" tppabs="http://www.tongshuai.com/water_heater/drsq/" channelid="98">电热水器</a>

                    <a href="rqrsq/index.htm" tppabs="http://www.tongshuai.com/water_heater/rqrsq/" channelid="99">燃气热水器</a>

                    <a href="kqnrsq/index.htm" tppabs="http://www.tongshuai.com/water_heater/kqnrsq/" channelid="100">空气能热水器</a>
        ...
        <div class="o_g prduct-title">
            ...
            <div class="o_u o_df_10-12">
                <div class="prolist-top">
                    ...
                    <span class="info">
							共<span class="red js_dataNum">2</span>款热水器产品
						</span>
                    <!--<div class="pro-group">
                ...
                <div class="prolist-con js_prolistBox">
                    ...
                    <div class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_2-2 o_xs_2-2 js_collectBox">
                        <div class="prolist-box">
                            ...
                            <span class="l-tag-radius l-tag-blue pro-tag">新品</span>




                            <div class="pro-opporate">
                                <a class="pro-read js_listCollect" data-productId="622" data-mdm="GD0RE3002" data-channelName="燃气热水器">
                                ...
                                <a class="pro-read l-fr js_compareAddProduct" auto="0"
                                   id="compare_622_top"
                                   data-id="compare_622_top"
                                   data-link="http://www.tongshuai.com/water_heater/20171214_622.shtml"
                                   data-thumb="http://image.tongshuai.com/tongshuai/water_heater/W020171214372415477503.png"
                                   data-name="安心LD3S系列"
                                   data-type="JSQ24-12LD3S(12T)"
                                   data-chnid="99">
                            ...
                            <a href="20171214_622.shtml.htm" tppabs="http://www.tongshuai.com/water_heater/20171214_622.shtml" class="pro-info-box">
                                <!--<img src="http://image.tongshuai.com/tongshuai/water_heater/W020171214372415477503_200.png" width="200"/>-->
                                <img src="../../image.tongshuai.com/tongshuai/water_heater/W020171214372415477503_200.png" tppabs="http://image.tongshuai.com/tongshuai/water_heater/W020171214372415477503_200.png" />
                                <!-- http://image.tongshuai.com/tongshuai/water_heater/W020171214372415477503_200.png -->
                    ...
                    <div class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_2-2 o_xs_2-2 js_collectBox">
                        <div class="prolist-box">
                            ...
                            <div class="pro-opporate">
                                <a class="pro-read js_listCollect" data-productId="623" data-mdm="GD0N5H004" data-channelName="燃气热水器">
                                        <span class="pro-read-i">
                                            <i class="iconfont icon-price-tag-solid1"></i>
                                        </span>
                                    <span class="pro-read-font">收藏</span>
                                ...
                                <a class="pro-read l-fr js_compareAddProduct" auto="0"
                                   id="compare_623_top"
                                   data-id="compare_623_top"
                                   data-link="http://www.tongshuai.com/water_heater/20171214_623.shtml"
                                   data-thumb="http://image.tongshuai.com/tongshuai/water_heater/W020171220325389425433.jpg"
                                   data-name="乐畅LE1系列"
                                   data-type="JSQ20-10LE1(12T)"
                                   data-chnid="99">
                                    <span class="pro-read-font">对比</span>
                                    <span class="pro-read-i">
											<i class="iconfont icon-contrast-solid"></i>
                            ...
                            <a href="20171214_623.shtml.htm" tppabs="http://www.tongshuai.com/water_heater/20171214_623.shtml" class="pro-info-box">
                                <!--<img src="http://image.tongshuai.com/tongshuai/water_heater/W020171220325389425433_200.jpg" width="200"/>-->
                                <img src="../../image.tongshuai.com/tongshuai/water_heater/W020171220325389425433_200.jpg" tppabs="http://image.tongshuai.com/tongshuai/water_heater/W020171220325389425433_200.jpg" />
                                <!-- http://image.tongshuai.com/tongshuai/water_heater/W020171220325389425433_200.jpg -->
                ...
                <div class="recommend-box">
                    ...
                    <div class="recommend-pro">
                        <div class="o_g js_recommend">
                            ...
                            <a class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_1-2 o_xs_1-2 o_df-hide" href="20171214_622.shtml.htm" tppabs="http://www.tongshuai.com/water_heater/20171214_622.shtml">
                                <img src="../../image.tongshuai.com/tongshuai/water_heater/W020171214372415477503.png" tppabs="http://image.tongshuai.com/tongshuai/water_heater/W020171214372415477503.png" />
                                <div class="recommend-pro-info">
                                    <span class="pro-info-title">安心LD3S系列</span>
                                    <span class="pro-info-type">JSQ24-12LD3S(12T)</span>
                                    <span class="pro-info-price js_minPrice" sku_value=''>￥<span>3199</span></span>
                                </div>
                            </a>

                            <a class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_1-2 o_xs_1-2 o_df-hide" href="20171214_623.shtml.htm" tppabs="http://www.tongshuai.com/water_heater/20171214_623.shtml">
                                <img src="../../image.tongshuai.com/tongshuai/water_heater/W020171220325389425433.jpg" tppabs="http://image.tongshuai.com/tongshuai/water_heater/W020171220325389425433.jpg" />
                                <div class="recommend-pro-info">
                                    <span class="pro-info-title">乐畅LE1系列</span>
                                    <span class="pro-info-type">JSQ20-10LE1(12T)</span>
                                    <span class="pro-info-price js_minPrice" sku_value=''>￥<span>3499</span></span>
                                </div>
                            </a>
                ...
                <div class="o_g footer_box">
                    ...
                    <div class="o_u o_df_1-6 o_md_1-4 o_sm_2-2 o_xs_2-2">
                        ...
                        <div class="foot_linkbox js_footLink">
                            ...
                            <a class="foot_link" href="index.jsp" tppabs="http://www.tongshuai.com/water_heater/">热水器</a>
...
<!--全局cookie end-->
<script>
    var table_name ="v_leader_dianreshuiqi,v_leader_rqrsq,v_leader_kqnrsq";
</script>
...
<script>
    ...
    var template_url="index.jsp"/*tpa=http://www.tongshuai.com/water_heater/*/
    var chnlid_owner ='75';
    cur();
    //var pagehtml = createPageHTMLS(1, "INDEX", "SHTML",2,7);
