...
<head>
    ...
    <title>【统帅空调】挂式_柜式_圆柱式_定频空调   介绍_价格 - 统帅官网</title>
    <meta name="keywords" content="【统帅空调】挂式_柜式_圆柱式_定频空调   介绍_价格 - 统帅官网" />
    <meta name="description" content="【统帅空调】挂式_柜式_圆柱式_定频空调   介绍_价格 - 统帅官网" />
    ...
    <div class="o_main">
                ...
                <ul class="o_u o_df_10-12 nav-mdbox">
                    ...
                    <li>
                        ...
                        <ul class="nav-mdbox-second js_navMdboxSecond">
                            ...
                            <li>
                                <a href="index.jsp" tppabs="http://www.tongshuai.com/air_conditioners/">
                                    <div class="nav-mdbox-icon">
        ...
        <div class="o_g list-nav">
            <div class="o_u o_df_2-2 list-nav-img">
                ...
                <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171223686923555775.jpg" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171223686923555775.jpg" class="o_u o_df_2-2 js_bannerImg" />


                <div class="list-nav-type black">

                    <div class="nav-type-img">
                        <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171223686923941323.png" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171223686923941323.png" />
                    </div>
                    <div class="nav-type-en">AIR CONDITIONER</div>
                    <div class="nav-type-china">空调</div>
                </div>
                ...
                <div class="list-kind-box">
                    <div class="list-kind js_showFloatList">
                        <div class="list-kind-icon">
                            ...
                            <img src="images/P020170925572252727655.png" tppabs="http://www.tongshuai.com/air_conditioners/images/P020170925572252727655.png"/>


                        </div>
                        <div class="list-kind-font">

                            <span class="list-kind-china">空调<i class="iconfont icon-arrow-line-down"></i><i class="iconfont icon-arrow-line-up"></i></span>


                            <span class="list-kind-english">AIR CONDITIONER</span>
        ...
        <div class="o_g prduct-title">
            ...
            <div class="o_u o_df_10-12">
                <div class="prolist-top">
                    ...
                    <span class="info">
							共<span class="red js_dataNum">5</span>款空调产品
						</span>
                    <!--<div class="pro-group">
                ...
                <div class="prolist-con js_prolistBox">
                    ...
                    <div class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_2-2 o_xs_2-2 js_collectBox">
                        <div class="prolist-box">
                            ...
                            <div class="pro-opporate">
                                <a class="pro-read js_listCollect" data-productId="633" data-mdm="AB91SY06N" data-channelName="空调产品">
                                ...
                                <a class="pro-read l-fr js_compareAddProduct" auto="0"
                                   id="compare_633_top"
                                   data-id="compare_633_top"
                                   data-link="http://www.tongshuai.com/air_conditioners/20171214_633.shtml"
                                   data-thumb="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216393354350207.jpg"
                                   data-name="统帅至尚自清洁3匹变频空调"
                                   data-type="KFR-72LW/09WAA21ATU1套机"
                                   data-chnid="96">
                            ...
                            <a href="20171214_633.shtml.htm" tppabs="http://www.tongshuai.com/air_conditioners/20171214_633.shtml" class="pro-info-box">
                                <!--<img src="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216393354350207_200.jpg" width="200"/>-->
                                <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171216393354350207_200.jpg" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216393354350207_200.jpg" />
                                <!-- http://image.tongshuai.com/tongshuai/air_conditioners/W020171216393354350207_200.jpg -->

                                <div class="pro-info-title">
                                    统帅至尚自清洁3匹变频空调
                                </div>
                                <div class="pro-info-mark">
                                    KFR-72LW/09WAA21ATU1套机
                                </div>
                    ...
                    <div class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_2-2 o_xs_2-2 js_collectBox">
                        <div class="prolist-box">
                            ...
                            <div class="pro-opporate">
                                <a class="pro-read js_listCollect" data-productId="636" data-mdm="AB8Y72012" data-channelName="空调产品">
                                        <span class="pro-read-i">
                                            <i class="iconfont icon-price-tag-solid1"></i>
                                        </span>
                                    <span class="pro-read-font">收藏</span>
                                ...
                                <a class="pro-read l-fr js_compareAddProduct" auto="0"
                                   id="compare_636_top"
                                   data-id="compare_636_top"
                                   data-link="http://www.tongshuai.com/air_conditioners/20171215_636.shtml"
                                   data-thumb="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216389357489393.jpg"
                                   data-name="统帅至美3匹变频自清洁柜式空调"
                                   data-type="KFR-72LW/22WBA22ATU1套机"
                                   data-chnid="96">
                                    <span class="pro-read-font">对比</span>
                                    <span class="pro-read-i">
											<i class="iconfont icon-contrast-solid"></i>
                            ...
                            <a href="20171215_636.shtml.htm" tppabs="http://www.tongshuai.com/air_conditioners/20171215_636.shtml" class="pro-info-box">
                                <!--<img src="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216389357489393_200.jpg" width="200"/>-->
                                <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171216389357489393_200.jpg" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216389357489393_200.jpg" />
                                <!-- http://image.tongshuai.com/tongshuai/air_conditioners/W020171216389357489393_200.jpg -->

                                <div class="pro-info-title">
                                    统帅至美3匹变频自清洁柜式空调
                                </div>
                                <div class="pro-info-mark">
                                    KFR-72LW/22WBA22ATU1套机
                                </div>
                                <div class="pro-info-price js_minPrice" sku_value=''>
                                    ¥<span>9999</span>
                                </div>
                    ...
                    <div class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_2-2 o_xs_2-2 js_collectBox">
                        <div class="prolist-box">
                            ...
                            <div class="pro-opporate">
                                <a class="pro-read js_listCollect" data-productId="631" data-mdm="AAABW006X" data-channelName="空调产品">
                                        <span class="pro-read-i">
                                            <i class="iconfont icon-price-tag-solid1"></i>
                                        </span>
                                    <span class="pro-read-font">收藏</span>
                                ...
                                <a class="pro-read l-fr js_compareAddProduct" auto="0"
                                   id="compare_631_top"
                                   data-id="compare_631_top"
                                   data-link="http://www.tongshuai.com/air_conditioners/20171214_631.shtml"
                                   data-thumb="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216405980663047.jpg"
                                   data-name="统帅至美 1.5匹智能WiFi空调"
                                   data-type="KFR-35GW/18UAA21ATU1套机"
                                   data-chnid="96">
                                    <span class="pro-read-font">对比</span>
                                    <span class="pro-read-i">
											<i class="iconfont icon-contrast-solid"></i>
                            ...
                            <a href="20171214_631.shtml.htm" tppabs="http://www.tongshuai.com/air_conditioners/20171214_631.shtml" class="pro-info-box">
                                <!--<img src="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216405980663047_200.jpg" width="200"/>-->
                                <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171216405980663047_200.jpg" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216405980663047_200.jpg" />
                                <!-- http://image.tongshuai.com/tongshuai/air_conditioners/W020171216405980663047_200.jpg -->

                                <div class="pro-info-title">
                                    统帅至美 1.5匹智能WiFi空调
                                </div>
                                <div class="pro-info-mark">
                                    KFR-35GW/18UAA21ATU1套机
                                </div>
                                <div class="pro-info-price js_minPrice" sku_value=''>
                                    ¥<span>5199</span>
                                </div>
                    ...
                    <div class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_2-2 o_xs_2-2 js_collectBox">
                        <div class="prolist-box">
                            ...
                            <div class="pro-opporate">
                                <a class="pro-read js_listCollect" data-productId="632" data-mdm="AAABN406N" data-channelName="空调产品">
                                        <span class="pro-read-i">
                                            <i class="iconfont icon-price-tag-solid1"></i>
                                        </span>
                                    <span class="pro-read-font">收藏</span>
                                ...
                                <a class="pro-read l-fr js_compareAddProduct" auto="0"
                                   id="compare_632_top"
                                   data-id="compare_632_top"
                                   data-link="http://www.tongshuai.com/air_conditioners/20171214_632.shtml"
                                   data-thumb="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216399979545601.jpg"
                                   data-name="统帅一级能效1.5匹智能变频静音空调"
                                   data-type="KFR-35GW/13AXA21ATU1"
                                   data-chnid="96">
                                    <span class="pro-read-font">对比</span>
                                    <span class="pro-read-i">
											<i class="iconfont icon-contrast-solid"></i>
                            ...
                            <a href="20171214_632.shtml.htm" tppabs="http://www.tongshuai.com/air_conditioners/20171214_632.shtml" class="pro-info-box">
                                <!--<img src="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216399979545601_200.jpg" width="200"/>-->
                                <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171216399979545601_200.jpg" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216399979545601_200.jpg" />
                                <!-- http://image.tongshuai.com/tongshuai/air_conditioners/W020171216399979545601_200.jpg -->

                                <div class="pro-info-title">
                                    统帅一级能效1.5匹智能变频静音空调
                                </div>
                                <div class="pro-info-mark">
                                    KFR-35GW/13AXA21ATU1
                                </div>
                                <div class="pro-info-price js_minPrice" sku_value=''>
                                    ¥<span>4299</span>
                                </div>
                    ...
                    <div class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_2-2 o_xs_2-2 js_collectBox">
                        <div class="prolist-box">
                            ...
                            <div class="pro-opporate">
                                <a class="pro-read js_listCollect" data-productId="635" data-mdm="AB8Y74013" data-channelName="空调产品">
                                        <span class="pro-read-i">
                                            <i class="iconfont icon-price-tag-solid1"></i>
                                        </span>
                                    <span class="pro-read-font">收藏</span>
                                ...
                                <a class="pro-read l-fr js_compareAddProduct" auto="0"
                                   id="compare_635_top"
                                   data-id="compare_635_top"
                                   data-link="http://www.tongshuai.com/air_conditioners/20171215_635.shtml"
                                   data-thumb="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216396610962826.jpg"
                                   data-name="统帅全能至尊3匹变频智能空调"
                                   data-type="KFR-72LW/07DCA21ATU1套机"
                                   data-chnid="96">
                                    <span class="pro-read-font">对比</span>
                                    <span class="pro-read-i">
											<i class="iconfont icon-contrast-solid"></i>
                            ...
                            <a href="20171215_635.shtml.htm" tppabs="http://www.tongshuai.com/air_conditioners/20171215_635.shtml" class="pro-info-box">
                                <!--<img src="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216396610962826_200.jpg" width="200"/>-->
                                <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171216396610962826_200.jpg" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216396610962826_200.jpg" />
                                <!-- http://image.tongshuai.com/tongshuai/air_conditioners/W020171216396610962826_200.jpg -->

                                <div class="pro-info-title">
                                    统帅全能至尊3匹变频智能空调
                                </div>
                                <div class="pro-info-mark">
                                    KFR-72LW/07DCA21ATU1套机
                                </div>
                                <div class="pro-info-price js_minPrice" sku_value=''>
                                    ¥<span>11999</span>
                                </div>
                ...
                <div class="recommend-box">
                    ...
                    <div class="recommend-pro">
                        <div class="o_g js_recommend">
                            ...
                            <a class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_1-2 o_xs_1-2 o_df-hide" href="20171214_633.shtml.htm" tppabs="http://www.tongshuai.com/air_conditioners/20171214_633.shtml">
                                <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171216393354350207.jpg" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216393354350207.jpg" />
                                <div class="recommend-pro-info">
                                    <span class="pro-info-title">统帅至尚自清洁3匹变频空调</span>
                                    <span class="pro-info-type">KFR-72LW/09WAA21ATU1套机</span>
                                    <span class="pro-info-price js_minPrice" sku_value=''>￥<span>12999</span></span>
                                </div>
                            </a>

                            <a class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_1-2 o_xs_1-2 o_df-hide" href="20171215_636.shtml.htm" tppabs="http://www.tongshuai.com/air_conditioners/20171215_636.shtml">
                                <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171216389357489393.jpg" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216389357489393.jpg" />
                                <div class="recommend-pro-info">
                                    <span class="pro-info-title">统帅至美3匹变频自清洁柜式空调</span>
                                    <span class="pro-info-type">KFR-72LW/22WBA22ATU1套机</span>
                                    <span class="pro-info-price js_minPrice" sku_value=''>￥<span>9999</span></span>
                                </div>
                            </a>

                            <a class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_1-2 o_xs_1-2 o_df-hide" href="20171214_631.shtml.htm" tppabs="http://www.tongshuai.com/air_conditioners/20171214_631.shtml">
                                <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171216405980663047.jpg" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216405980663047.jpg" />
                                <div class="recommend-pro-info">
                                    <span class="pro-info-title">统帅至美 1.5匹智能WiFi空调</span>
                                    <span class="pro-info-type">KFR-35GW/18UAA21ATU1套机</span>
                                    <span class="pro-info-price js_minPrice" sku_value=''>￥<span>5199</span></span>
                                </div>
                            </a>

                            <a class="o_u o_df_1-4 o_lg_1-3 o_md_1-2 o_sm_1-2 o_xs_1-2 o_df-hide" href="20171214_632.shtml.htm" tppabs="http://www.tongshuai.com/air_conditioners/20171214_632.shtml">
                                <img src="../../image.tongshuai.com/tongshuai/air_conditioners/W020171216399979545601.jpg" tppabs="http://image.tongshuai.com/tongshuai/air_conditioners/W020171216399979545601.jpg" />
                                <div class="recommend-pro-info">
                                    <span class="pro-info-title">统帅一级能效1.5匹智能变频静音空调</span>
                                    <span class="pro-info-type">KFR-35GW/13AXA21ATU1</span>
                                    <span class="pro-info-price js_minPrice" sku_value=''>￥<span>4299</span></span>
                                </div>
                            </a>
                ...
                <div class="o_g footer_box">
                    ...
                    <div class="o_u o_df_1-6 o_md_1-4 o_sm_2-2 o_xs_2-2">
                        ...
                        <div class="foot_linkbox js_footLink">
                            ...
                            <a class="foot_link" href="index.jsp" tppabs="http://www.tongshuai.com/air_conditioners/">空调</a>
...
<!--全局cookie end-->
<script>
    var table_name ="v_leader_kongtiao";
</script>
...
<script>
    ...
    var template_url="index.htm"/*tpa=http://www.tongshuai.com/air_conditioners/*/
    var chnlid_owner ='74';
    cur();
